...
const notificationList = [
  {
    image: "/images/user/blue-icon.png",
    title: "New message received",
    subTitle: "Anon456 sent you a new message",
  },
  {
    image: "/images/user/red-icon.png",
    title: "A message was received",
    subTitle: "MedUser789 replied to your message",
  },
  {
    image: "/images/user/green-icon.png",
    title: "Low supply of oxygen tanks",
    subTitle: "Check your inventory",
  },
  {
    image: "/images/user/blue-icon.png",
    title: "Decreased sepsis cases treated",
    subTitle: "Monitor activity",
  },
  {
    image: "/images/user/red-icon.png",
    title: "New message received",
    subTitle: "Clinician202 started a conversation",
  },
];
